...
CREATE TRIGGER profile_id_to_metadata_trigger AFTER INSERT OR DELETE OR UPDATE ON public.user_profiles FOR EACH ROW EXECUTE FUNCTION private.profile_id_to_metadata();

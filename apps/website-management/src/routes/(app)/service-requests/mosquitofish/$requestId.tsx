...
export const Route = createFileRoute(
	...
	loader: () => {
		return { crumb: "Mosquitofish Request" };
	},
});
		...
		<div className="max-w-2xl space-y-6">
			<nav className="flex items-center justify-between rounded-lg border bg-card p-4">
				...
				<Button asChild size="sm" variant="outline">
					<Link
						...
						to="/service-requests/mosquitofish/$requestId/edit"
					>
						<Edit />
						Edit
					</Link>
			...
			<article className="space-y-4">
				<div className="flex items-baseline gap-2">
					<h2 className="font-bold text-2xl">Mosquitofish Request</h2>
				...
				<div className="rounded-lg border p-4">
					<h3 className="mb-2 font-semibold">Type of Water Body</h3>
					<p>{request.type_of_water_body}</p>
				</div>

				<div className="rounded-lg border p-4">
					<h3 className="mb-2 font-semibold">Location of Water Body</h3>
					<p>{request.location_of_water_body}</p>
				</div>

	...
	return (
		<div className="mx-auto w-full max-w-7xl p-4">
			<article className="prose lg:prose-xl max-w-none">
				<h1>Leadership</h1>
				<p>
					The Middlesex County Mosquito Extermination Commission (MCMEC) is led
					by a dedicated board of commissioners appointed by the Middlesex
					County Board of County Commissioners . Operating as a body politic in
					accordance with New Jersey State Law (N.J.S.A. 26:9-1 et seq.), the
					Commission is composed of six appointive members—at least three of
					whom possess experience in public health—alongside the Director of the
					State Experiment Station and the Commissioner of Health serving as
					ex-officio members.
				</p>
				<ul>
